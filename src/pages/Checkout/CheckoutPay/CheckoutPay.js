                ...
                <div className='p-5  w-2/3'>
                    <div className='bgCheckout'>
                        ...
                        <form className='my-10'>
                            ...
                            <input type="text" placeholder='Credit card number' className='p-2 m-2 bg-transparent w-3/5' />
                            <input type="text" placeholder='Exp date' className='p-2 m-2 bg-transparent w-2/5' />
                            <input type="text" placeholder='CW' className='p-2 m-2 bg-transparent w-2/5' />
                        </form>
                        ...
                        <div>
                            ...
                            <button className='w-1/6 p-2  ml-1 rounded-lg font-bold textWhite' style={{ background: '#7f66de' }} onClick={() => { history.push(`/checkoutfinish/${props.match.params.id}`) }}>Next</button>
                        </div>
