...
export default function Footer() {
    return (
        <footer className="py-6 dark:bg-coolGray-800 dark:text-coolGray-50 container bg-gray-500 text-white w-full mr-0">
            <div className="container px-6 mx-auto space-y-6 divide-y divide-coolGray-400 md:space-y-12 divide-opacity-50 w-full">

                <div className="grid grid-cols-12">
                    <div className="pb-6 col-span-full md:pb-0 md:col-span-3 mx-auto">
                        <a rel="noopener noreferrer" href="#" aria-label="Back to homepage" className="flex items-center p-2">
                            ...
                            <span className='nameCinema text-2xl'>JACK'S CINEMA</span>
                        </a>
                    </div>
                        ...
                        <div className=' grid grid-cols-12 w-full '>
                            ...
                            <div className='pb-1 text-lg font-medium col-span-6 text-center md:text-left md:col-span-12 grid grid-cols-12 w-full'>
                                <div className="col-span-12 text-center md:text-left sm:col-span-4 ">
                                    <ul>
                                        <li>
                                            <p className="mb-0 text-lg font-medium">Jack's Town</p>
                                            <p className='text-xs opacity-70'>Lien Chieu,Da Nang city.</p>
                                        </li>
                                        ...
                                        <li>
                                            <div className="flex justify-start pt-4 space-x-4 lg:pt-0 lg:col-end-13">
                                                ...
                                                <a rel="noopener noreferrer" href="#" title="GitHub" className="flex items-center justify-center w-10 h-10 rounded-full dark:bg-violet-400 dark:text-coolGray-900">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" className="w-5 h-5 text-teal-400	">
